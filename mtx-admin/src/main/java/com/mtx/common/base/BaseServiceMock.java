...
public abstract class BaseServiceMock<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	@Override
	public List<Record> selectByExampleWithBLOBsForOffsetPage(Example example, Page page) {
		return null;
	}

	@Override
	public List<Record> selectByExampleForOffsetPage(Example example, Page page) {
		return null;
	}
