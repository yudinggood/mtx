...
Annotation.prototype = {
	...
	render: function (redraw) {
		...
		// link annotation to point or series
...
// Add annotation methods to chart prototype
extend(Chart.prototype, {
	annotations: {
		/*
		 * Unified method for adding annotation to the chart
		 */
		...
		/**
		 * Redraw all annotation, method used in chart events
		 */
		redraw: function () {
...
Chart.prototype.callbacks.push(function (chart) {
	...
	// initialize empty array for annotation
	chart.annotations.allItems = [];

	// link chart object to annotation
	chart.annotations.chart = chart;

	// link annotation group element to the chart
	...
	// update annotation after chart redraw
