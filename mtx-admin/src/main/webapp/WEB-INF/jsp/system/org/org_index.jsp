...
<div class="easyui-layout" fit="true" scroll="no">
    ...
    <div region="center" title="详细信息" >
        <div class="easyui-panel" style="padding:0px;border:0px" fit="true" border="false" id="orgListpanel"></div>
    </div>
...
<script>
    ...
    function zTreeOnClick(event, treeId, treeNode){
        $('#orgListpanel').panel("refresh", "${basePath}/system/org/view/"+treeNode.id);
    }
